---
name: nview-a-terfi-envest
description: |
  nView 'a-terfi-envest' için GENEL.phtml'den otomatik çıkarılmış tag/birim/etiket eşlemesi.
  Use when: node.nView == "a-terfi-envest" ve tag anlamı, birim, rolü soruluyorsa.
  Keywords: BasincSensoru, Debimetre, a-terfi-envest.
version: "1.0.0"
generated: true
source: //10.10.10.72/public/dev.korubin/app/views/point/display/common/a-terfi-envest/GENEL.phtml
---

# nView: a-terfi-envest
...
| `Rulman1Sicaklik` | [langt:Arka Bilya Isı] | °C | 1 | unknown | (col) |
| `Rulman2Sicaklik` | [langt:Ön Bilya Isı] | °C | 1 | unknown | (col) |
| `Rulman3Sicaklik` | [langt:Rulman 3] | °C | 1 | unknown | (col) |
| `Rulman4Sicaklik` | [langt:Rulman 4] | °C | 1 | unknown | (col) |
...
- **status**: `ACT_1_Durum`
- **unknown**: `LocalMod`, `ScadaMod`, `ServisMod`, `Sulama_Basladi`, `XVN_ACTAktif`

---
name: nview-a-aqua-cnt-depo
description: |
  nView 'a-aqua-cnt-depo' için GENEL.phtml'den otomatik çıkarılmış tag/birim/etiket eşlemesi.
  Use when: node.nView == "a-aqua-cnt-depo" ve tag anlamı, birim, rolü soruluyorsa.
  Keywords: BasincSensoru, Debimetre, a-aqua-cnt-depo.
version: "1.0.0"
generated: true
source: https://<panel_base_url>/panel/point/<node_id>/<menu>
---

# nView: a-aqua-cnt-depo
...
|---|---|---|---|---|---|
| `BasincSensoru` | Çıkış basıncı | m³/h | 2 | measurement | langt=Debimetre; (div) |
...
| `XC_KapasiteBilgi` | Çalışma modu / mod seçim | m³ | 2 | operating_mode | langt=Kapasite; (div) |
...
- **unknown**: `DepoTekSeviye`, `PilSicaklik`
...
| `arayuz` | [langt:Enerji-Besleme] | [langt:Depo Ayarları] | — |

## Birim Özeti

- **Debi**: `BasincSensoru`, `Debimetre`, `Debimetre2`

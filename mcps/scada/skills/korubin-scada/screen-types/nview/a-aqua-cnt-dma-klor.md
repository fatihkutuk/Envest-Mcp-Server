---
name: nview-a-aqua-cnt-dma-klor
description: |
  nView 'a-aqua-cnt-dma-klor' için GENEL.phtml'den otomatik çıkarılmış tag/birim/etiket eşlemesi.
  Use when: node.nView == "a-aqua-cnt-dma-klor" ve tag anlamı, birim, rolü soruluyorsa.
  Keywords: BasincSensoru, a-aqua-cnt-dma-klor.
version: "1.0.0"
generated: true
source: //10.10.10.72/public/dev.korubin/app/views/point/display/common/a-aqua-cnt-dma-klor/GENEL.phtml
---

# nView: a-aqua-cnt-dma-klor
...
- **unknown**: `DepoSeviye`, `PhSensoru`, `_NoError`

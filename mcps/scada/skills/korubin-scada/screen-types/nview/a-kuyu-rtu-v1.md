---
name: nview-a-kuyu-rtu-v1
description: |
  nView 'a-kuyu-rtu-v1' için GENEL.phtml'den otomatik çıkarılmış tag/birim/etiket eşlemesi.
  Use when: node.nView == "a-kuyu-rtu-v1" ve tag anlamı, birim, rolü soruluyorsa.
  Keywords: BasincSensoru, Debimetre, StatikSeviye, SuSeviye, a-kuyu-rtu-v1.
version: "1.0.0"
generated: true
source: //10.10.10.72/public/dev.korubin/app/views/point/display/common/a-kuyu-rtu-v1/GENEL.phtml
---
...
| `T_ElektrikReakInduSayac` | Toplam sayaç (su, elektrik, çalışma, şalt) | kVAR | 2 | counter | langt=Reaktif İnduktif; (div) |
| `T_ElektrikReakKapaSayac` | Toplam sayaç (su, elektrik, çalışma, şalt) | kVAR | 2 | counter | langt=Reaktif Kapasitif; (div) |
...
| `m3Maliyet` | [langt:Birim Maliyeti] | m³/TL | 2 | unknown | (div) |
...
| `xGunMaliyet` | [langt:Toplam Maliyet] |  | 2 | unknown | (div) |
| `XR_SystemAliveTime` | [langt:RTU Çalışma Süresi] | h | 1 | unknown | (div) |
...
| `calismamod` | [langt:Sabitleme] | [langt:Çalışma Ayarları] | `XINV_SurucuFrekansReferans` |
| `sistem` | [langt:Sistem] | [langt:Sistem Ayarları] | `XS_StatikSevGuncSure` |
| `sensor` | [langt:Sensör] | [langt:Sensör Ayarları] | `XS_BasincMax`, `XS_BasincKalibre`, `BasincSensoru`, `XS_HatBasincMax`, `XS_HatBasincKalibre`, `BasincSensoru2`, `XS_SeviyeMax`, `XS_SeviyeKalibre` …+12 |
...
| `emniyet` | [langt:Emniyet] | [langt:Emniyet Ayarları] | `XE_FrekansAlt`, `XE_FrekansUst`, `XE_FrekansSure`, `XE_VoltajAlt`, `XE_VoltajUst`, `XE_VoltajSure`, `XE_AkimAlt`, `XE_AkimUst` …+37 |
...
| `depo_doldurma` | [langt:Depo Doldurma] | [langt:Depo Doldurma Ayarları] | `XD_CikisDepoAlt`, `XD_CikisDepoUst`, `XD_CikisDepoKritikAlt`, `XD_CikisDepoKritikUst` |
| `hidrofor_mod_ayar` | [langt:Hid. Mod Ayr.] | [langt:Hidrofor Modu Ayarları] | `XHID_CalismaSeviye`, `XHID_DurmaSeviye`, `XHID_CalismaKontrolSuresi`, `XHID_DurmaKontrolSuresi` |
...
- **Debi**: `Debimetre`
- **Seviye / uzunluk (m/cm)**: `-Link1_DepoSeviye`, `NPSHSeviye`, `StatikSeviye`, `SuSeviye`, `XD_BasmaYukseklik`, `XD_CikisDepoYukseklik`, `toplamHm`

---
name: nview-a-aqua-cnt-terfi-v2
description: |
  nView 'a-aqua-cnt-terfi-v2' için GENEL.phtml'den otomatik çıkarılmış tag/birim/etiket eşlemesi.
  Use when: node.nView == "a-aqua-cnt-terfi-v2" ve tag anlamı, birim, rolü soruluyorsa.
  Keywords: BasincSensoru, Debimetre, a-aqua-cnt-terfi-v2.
version: "1.0.0"
generated: true
source: //10.10.10.72/public/dev.korubin/app/views/point/display/common/a-aqua-cnt-terfi-v2/GENEL.phtml
---

# nView: a-aqua-cnt-terfi-v2
...
- **measurement**: `Pompa1StartStopDurumu`, `SuSeviye`, `ToplamHm`
...
| `sensor` | [langt:Sensör] | <span style="color:rgb(153, 0, 0);" id="montajToggle"><ico id="montajIkon" class="down"></ico></span> | `XS_MontajSev`, `XS_MontajDerinlik`, `NPSHSeviye`, `DepoSeviye`, `DinamikSeviye`, `XS_BasincSensoruMax`, `BasincSensoru`, `XS_BasincSensoru2Max` …+12 |
...
| `pumpclustring` | [langt:Pump-clustering] | [langt:pump-clustring] | — |

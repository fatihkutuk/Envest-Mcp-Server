---
name: nview-a-aqua-cnt-depo-klor
description: |
  nView 'a-aqua-cnt-depo-klor' için GENEL.phtml'den otomatik çıkarılmış tag/birim/etiket eşlemesi.
  Use when: node.nView == "a-aqua-cnt-depo-klor" ve tag anlamı, birim, rolü soruluyorsa.
  Keywords: a-aqua-cnt-depo-klor.
version: "1.0.0"
generated: true
source: //10.10.10.72/public/dev.korubin/app/views/point/display/common/a-aqua-cnt-depo-klor/GENEL.phtml
---

# nView: a-aqua-cnt-depo-klor
...
|---|---|---|---|---|---|
| `T_SuC1SayacS` | Su Sayaç (Sunucu) | m³ | 2 | counter | Toplam sayaç (su, elektrik, çalışma, şalt); (div) |
| `T_SuSayac` | Su Sayaç (Cihaz) | m³ | 2 | counter | Toplam sayaç (su, elektrik, çalışma, şalt); (div) |
| `BeslemeVoltaji` | <ico class="battery"></ico>Besleme Voltajı | V | 2 | unknown | (div) |
| `DebimetreC1` |  | m³ | 2 | unknown |  |
| `DepoBos` | [langt:Top. Boş] | m³ | 2 | unknown | (div) |
| `DepoSuMiktari` | [langt:Top. Su Miktarı] | m³ | 2 | unknown | (div) |
| `PilSeviye` | <ico class="battery"></ico>Pil Durumu | % | 2 | unknown | (div) |
| `PilSicaklik` | <ico class="battery"></ico>Pil Sıcaklık | °C | 2 | unknown | (div) |
...
- **unknown**: `DebimetreC2`, `DebimetreC3`, `DebimetreC4`, `DebimetreG1`, `DebimetreG2`, `DebimetreG3`, `DebimetreG4`, `Depo2Seviye`, `DepoSeviye`, `DijitalGirisler`
